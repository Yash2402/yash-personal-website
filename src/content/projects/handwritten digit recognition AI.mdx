...
<Resource
  title="Samson Zhang's video on build neural network in python using numpy and pandas."
  url=""
/>
<Resource
  title="3Blue1Brown playlist on underline mathematics in neural networks."
  url="https://youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&si=OaSzJLS9RNrgr5Sv"
/>
