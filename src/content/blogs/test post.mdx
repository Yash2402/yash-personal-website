...
1. LaTeX does not work (inline math is not working and i have to write it in fuckin code blocks)
2. table not working in mdx
3. Obsidian Like Callouts don't work
    - look weird
4. internal linking like [[Coutionary Tale]]
    - requires mdx
