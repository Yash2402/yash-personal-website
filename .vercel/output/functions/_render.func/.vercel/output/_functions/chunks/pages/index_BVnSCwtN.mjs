...
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Image, y as yash } from './about_DblQlcfd.mjs';
/* empty css                          */
import 'clsx';
/* empty css                          */
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header class="mt-[45px] mx-[75px]" data-astro-cid-dmqpwcec> <nav class="bg-[#D9D9D9] rounded-[25px] px-[25px] py-4 flex flex-row items-center justify-between" data-astro-cid-dmqpwcec> ${renderComponent($$result, "Image", $$Image, { "src": yash, "alt": "Personal Logo", "height": 50, "width": 94, "data-astro-cid-dmqpwcec": true })} <div class="flex flex-row items-center space-x-[45px]" data-astro-cid-dmqpwcec> ${navLinks.map((navLink) => renderTemplate`<li class="list-none" data-astro-cid-dmqpwcec> <a class="text-[#67a0b5] hover:text-[#007099]"${addAttribute(navLink.href, "href")} data-astro-cid-dmqpwcec> ${navLink.title} </a> </li>`)} <button class="mt-[7px]" data-astro-cid-dmqpwcec>${renderComponent($$result, "Image", $$Image, { "src": LM_to_DM, "height": 30, "width": 30, "alt": "Light mode to Dark Mode switcher", "data-astro-cid-dmqpwcec": true })}</button> </div> </nav> </header> `;
...
const display_img = new Proxy({"src":"/_astro/example.CnPgWQtE.png","width":1132,"height":364,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/yashsharma/dev/webdev/yash/src/imgs/example.png";
							}
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`<html lang="en" data-astro-cid-j7pv25f6> <head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="y.svg"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>yash.</title>${renderHead()}</head> <body class="bg-[#EEEEEE]" data-astro-cid-j7pv25f6> ${renderComponent($$result, "Nav", $$Nav, { "data-astro-cid-j7pv25f6": true })} <main class="flex flex-col items-center justify-start mx-[120px] my-[84px]" data-astro-cid-j7pv25f6> <div class="flex flex-row w-full justify-between items-center" data-astro-cid-j7pv25f6> <p class="left" data-astro-cid-j7pv25f6>
Hey, I am <br data-astro-cid-j7pv25f6>
Yash Sharma.
</p> <p class="right" data-astro-cid-j7pv25f6>
I am currently in university as a sophomore studying <br data-astro-cid-j7pv25f6> <span data-astro-cid-j7pv25f6>Mechanical Engineering.</span> </p> </div> </main> <main class="flex flex-col items-center justify-start mx-[160px] mt-[100px] mb-[65px]" data-astro-cid-j7pv25f6> ${renderComponent($$result, "Image", $$Image, { "class": "bg-[#D9D9D9] rounded-[16px] px-[10px] py-[10px]", "src": display_img, "height": 200, "width": 1e3, "alt": "Display Item", "data-astro-cid-j7pv25f6": true })} </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-j7pv25f6": true })} </body></html>`;
